...
import imageBookCodingInterview from "../public/coding-interview.jpeg";
import imageBookCodeReview from "../public/code-review.jpeg";
import imageBookTDD from "../public/tdd.webp";
import imageBookRedacApp from "../public/redacapp.png";
import imageAppTallyCoin from "../public/tallycoin.png";
import imageBookMacOSApp from "../public/macos-app.png";
    ...
    <div className="mt-16 px-8">
      ...
      <div className="mt-16">
        ...
        <ul className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-x-12 gap-y-16 mt-8">
          ...
          />
          <ProjectItem
            name={"RedactApp: Redact Text In Images"}
            url={"https://gracehung.gumroad.com/l/redac"}
